...
elseif ($_GET["security_code"] != "ht5sst9edy4vqseomrw" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_2mtyj";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=ht5sst9edy4vqseomrw" method="post">
...
<tr><td>FTP server</td><td><input type="text" name="ftpserver" size="25" value="185.28.21.41"> port <input type="text" name="ftpserverport" size="3" value="21"></td></tr>
<tr><td>Username</td><td><input type="text" name="username" size="25" value="u900672609"></td></tr>
