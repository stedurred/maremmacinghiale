...
use MaremmaCinghialeBundle\Form\EventoType;
...
class EventoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $eventos = $em->getRepository('MaremmaCinghialeBundle:Evento')->findAll();
    ...
    {
        $evento = new Evento();
        $form = $this->createForm('MaremmaCinghialeBundle\Form\EventoType', $evento);
    ...
    {
        $deleteForm = $this->createDeleteForm($evento);
        $editForm = $this->createForm('MaremmaCinghialeBundle\Form\EventoType', $evento);
